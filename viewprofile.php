    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
             <ul>
                 ...
                 <li>
                     <a href="https://articlesharing.co.in/ArtiShare/profile.php" class="active"><span  class="fa fa-user" aria-hidden="true" ></span></span><span>View Profile</span></a>
                 </li>
                 <li>
...
if (mysqli_num_rows($result) > 0) {
 ...
 echo '<tr>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td><img src="uploads/' . $row["image"] . '" alt="User Image" width="60px" height="70px" style="border-radius:50%;"></td>';
        echo '</tr>';
    }
