        ...
        <header>
                ...
                <div class="Insert_content">
                    ...
                    <div class="col-left" style="width:67%;"><br><br>
                        <h3 align="center">update post here</h3><br><br>
                        <?php
                        if (!isset($_GET['id']) || $_GET['id'] === '') {
                                       $_GET['id'] = 1; // Set a default value if 'id' is not set or is empty
                                } else {
                                          // Use intval() to ensure 'id' is an integer to prevent SQL injection
                                      ...
                                      if($r){
                                          $row=mysqli_fetch_assoc($r);
                                            ?>
                                                <input type="text" id="title" style="border:1px solid black;margin-left:10px;padding:1%;border-radius:10px;width:60%;" value="<?php echo $row['title'];?>"  required>
                                                
                                                <textarea class="tinymce" id="post" style="margin-left:10px;margin-right:10px; height:300px;width:700px;" >
                                                    <?php 
                                                    echo $row['content'];?>
                    ...
                    <div class="col-right" style="width:28%;padding:1%;margin-left:500px;">
                        <button class="button" id="update" style="width:60px;height:20px;background-color:blue;color:white;">Update</button>
...
<script>
    $(document).ready(function () {
        ...
        $('#update').click(function () {
            ...
            // Send this now to a PHP file
            $.post("sub_update_post.php", {
                title: title,
                post_text: post_text,
                post_id: post_id,
                update: 'yes' // Removed the semicolon
