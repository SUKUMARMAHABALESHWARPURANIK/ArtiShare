<?php
// Make sure to establish a database connection first using mysqli_connect() and assign it to $conn.
require_once("connection.php");
// Visiting this page will add +1 to view
        ...
        <div class="sidebar-menu">
             <ul>
                 ...
                 <li>
                     ...
                     ?>
                      <a href=""><span   class="fa fa-clipboard" aria-hidden="true"></span></span><span>All post</span><span style="float:right;margin-right:10px;"><?php echo $all_post;?></span></a>
                 ...
                 <li>
                       <a href=""><span   i class="fa fa-arrows-alt" aria-hidden="true"></i></span></span><span>Capacity</span><span>2</span></a>
                             ...
                             <div class="content">
                               ...
                               <div class="col-left">
                                ...
                                <div class="col-right">
                                    ...
                                    if($r){
                                        while($row=mysqli_fetch_assoc($r)){
                                            ...
                                            echo '<span style="color:red">'.$status.'</span>';
                                              ...
                                              echo '<br>';
                                              echo '<i class="fa fa-eye" aria-hidden="true"></i><a href="view.php?id='.$id.'">View </a>';
                                              ?>
                                               <i class="fa fa-trash" aria-hidden="true"></i><a onclick="document.getElementById('confirm<?php echo $id;?>').style.display='block'" style="color:red;cursor:pointer;">Delete</a>&nbsp;
                                                           
                                                <!-- Window will confirm whether to delete a post -->
                                                <div id="confirm<?php echo $id;?>" class="confirm">
                                                          <!-- Head of the window -->
                                                <p class="w-head">Delete post</p>
                                          ...
                                          <!-- Footer of the window -->
                                                <p class="w-footer">
                                                    <button onclick="delete_post(<?php echo $id;?>)" class="w-button">Yes</button>
                                              ...
                                              echo ' <i class="fa fa-pencil" aria-hidden="true"></i> <a href="update.php?id='.$id.'">Repost</a>';           
                                            //   echo ' <i class="fa fa-thumbs-up" aria-hidden="true"></i> <a href="">Like  <span id="likeCount">0</span></a>';
                                            //   echo ' <i class="fa fa-thumbs-down" aria-hidden="true"></i> <a href="">Dislike    <span id="dislikeCount">0</span></a>';
                                              
                                            
                                        }
                                    }else{
                                        echo $q.'query problem';
                                    }
                                   ...
                                   <script>
        // JavaScript to handle like and dislike buttons
        let likeCount = 0;
        let dislikeCount = 0;
                         ...
                         <script>
                            function delete_post(id){
                                ...
                                $.post("delete_process.php",{
                                  ...
                                  function(data,status){
                                      alert(data);
                                      location:href='AdminIndex.php?id=<?php echo $_GET['id']; ?>';
                  }
                );
            }
        </script>
