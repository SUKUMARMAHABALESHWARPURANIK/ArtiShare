...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
             <ul>
                 ...
                 <li>
                     <a href="https://articlesharing.co.in/ArtiShare/fandq.php" class="active"><span  class="fa fa-tasks" aria-hidden="true"></span></span><span>F&Q</span></a>
                 </li>
                    <li>
    ...
    <div class="main-content">
        <header>
              ...
              <section class="faqs">
    <img src="https://img.freepik.com/free-vector/faq-concept_23-2148157552.jpg?size=626&ext=jpg&ga=GA1.1.469211386.1694256295&semt=ais">
    ...
    <div class="faq">
        <h3>Q: What types of articles can I share?</h3>
        <p>A: You can share articles on a wide range of topics, including technology, travel, health, and more. We welcome diverse content from our users.</p>
    </div>

    <div class="faq">
        <h3>Q: Is there a word limit for articles?</h3>
        <p>A: Yes, there is a maximum word limit of 2000 words for articles. Please ensure your articles fit within this limit.</p>
    </div>

    <div class="faq">
        <h3>Q: How long does it take for my article to be published?</h3>
        <p>A: Typically, it takes 1-2 business days for our editorial team to review and publish your article. You will receive a notification once it's live.</p>
    </div>

    <div class="faq">
        <h3>Q: Can I edit my published articles?</h3>
        <p>A: Yes, you can edit your published articles. Simply go to your profile, find the article, and click on the 'Edit' button.</p>
    </div>

    <div class="faq">
        <h3>Q: How can I promote my articles?</h3>
        <p>A: We offer various promotion options, including featured articles and social media sharing. You can explore these options in your profile.</p>
    </div>

    <div class="faq">
        <h3>Q: Are there any restrictions on content?</h3>
        <p>A: We have content guidelines in place to ensure a safe and respectful environment. Please review our guidelines before submitting articles.</p>
    </div>

    <div class="faq">
        <h3>Q: How do I contact support for assistance?</h3>
        <p>A: If you need assistance or have any questions, you can reach our support team through the 'Contact Us' page on the website.</p>
    </div>

    <div class="faq">
        <h3>Q: Is there a mobile app available?</h3>
        <p>A: Currently, we offer a responsive website that works well on both desktop and mobile devices. We are working on a mobile app for the future.</p>
    </div>
</section>
