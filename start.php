    ...
    <div class="container fluid">
      ...
      <form id="redirectForm" method="post" action="request.php">
        <div class="form-group">
          ...
          <input class="form-control" name="appId" value="TEST100139145ce24a84658fe977225841931001"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input class="form-control" name="returnUrl" value="https://articlesharing.co.in/ArtiShare/response.php"/>
        </div>        
        <div class="form-group">
